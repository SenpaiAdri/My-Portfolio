...
const Skills = () => {
  ...
  const skillList = skills.map((skill) => (
    <motion.div
      ...
      className="bg-[#131316] rounded-[30px] w-full p-5 gap-4 flex flex-col items-center
      md:rounded-[40px] 
      lg:rounded-4xl  shadow-xl 
      shadow-black/20 hover:shadow-black/50"
    ...
    >
      <h1 className="text-white text-base md:text-xl md:py-4 text-center">
        {skill.type}
      </h1>
  ...
  return (
    <div id="skills">
      <div className="bg-black flex flex-col items-center justify-center py-5 md:py-15 px-5 md:px-10">
        ...
        {/* Skills Container */}
        <motion.div
          className="bg-[#26262C] rounded-[35px] p-5 my-6 gap-6 grid grid-cols-1 
        ...
        hover:shadow-[#26262C]/20 transition-shadow duration-300 shadow-xl shadow-[#26262C]/10"
