  ...
  return (
    <div id="about" className="relative w-full py-20 px-10 items-center justify-center md:px-25 bg-[#E8E8E8] dark:bg-[#0a0a0a] overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-10 mt-20 items-center justify-center w-full">
          {/* Text Content */}
          <motion.div
            ...
            viewport={{ amount: 0.2 }}
          >
            <p className="text-neutral-600 dark:text-gray-300 text-base md:text-xl leading-relaxed">
              Hi, I&apos;m <span className="text-neutral-900 dark:text-white font-semibold">Adrian M. De Guzman</span>, a Computer Science student specialized in
              <span className="text-neutral-900 dark:text-white"> Mobile Programming</span>.
              I'd like to explore new technologies, learn new skills, and adapt to the fast-changing tech industry.
            </p>
            ...
            <p className="text-neutral-600 dark:text-gray-300 text-base md:text-xl leading-relaxed">
              I look forward to working in environments that focuses on good engineering practices,
